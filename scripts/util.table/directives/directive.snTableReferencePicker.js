/*! RESOURCE: /scripts/util.table/directives/directive.snTableReferencePicker.js */
angular
  .module('sn.table')
  .directive(
    'snTableReferencePicker',
    function (
      $timeout,
      $http,
      urlTools,
        ...
        link: function (scope, element, attrs, ctrl) {
          ...
          var select2AjaxHelpers = {
            ...
            formatResult: function (item) {
              ...
              if (displayValues.length == 1) return $sanitize(displayValues[0]);
