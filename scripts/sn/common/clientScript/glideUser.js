...
(function (exports, undefined) {
  ...
  function GlideUser(fields) {
    ...
    this.hasRoles = function (includeDefaults) {
      if (includeDefaults) return _allRoles && _allRoles.length > 0;
      else return _roles && _roles.length > 0;
    };
    this.hasRoleExactly = function (role, includeDefaults) {
      if (
        !this.hasRoles(includeDefaults) ||
        !role ||
        typeof role !== 'string'
      ) {
        return false;
      ...
      if (includeDefaults) rolesToCheck = _allRoles;
