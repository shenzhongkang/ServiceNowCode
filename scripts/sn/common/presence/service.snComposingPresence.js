...
angular
  .module('sn.common.presence')
  .service('snComposingPresence', function (i18n) {
    'use strict';
    var viewing = {};
    var typing = {};
    var allStrings = {};
    ...
    i18n.getMessages(
      [typing1, typing2, typingMore, viewing1, viewing2, viewingMore],
      function (results) {
    ...
    function generateAllString(conversationID, members) {
      ...
      if (typingLength < 4 && viewingLength < 4) return '';
      switch (typingLength) {
        case 0:
          break;
        case 1:
        ...
        case 2:
          result += i18n.format(
            typing2,
            members.typing[0].name,
            members.typing[1].name
          );
          break;
        default:
          var allButLastTyper = '';
          for (var i = 0; i < typingLength; i++) {
            if (i < typingLength - 2)
              ...
              result += i18n.format(
                typing2,
                allButLastTyper,
                members.typing[i].name
              );
          }
      }
      if (viewingLength > 0 && typingLength > 0) result += '\n\n';
      switch (viewingLength) {
        ...
        case 2:
          result += i18n.format(
            viewing2,
            members.viewing[0].name,
            members.viewing[1].name
          );
          break;
        default:
    ...
    function generateShortString(conversationID, members) {
      ...
      switch (typingLength) {
        ...
        case 3:
          typingString = i18n.format(
            typing2,
            members.typing[0].name + ', ' + members.typing[1].name + ',',
            members.typing[2].name
          );
          break;
        default:
          typingString = i18n.format(
      ...
      if (viewingLength > 0 && typingLength > 0) inBetween = '. ';
      switch (viewingLength) {
        case 0:
          break;
        case 1:
        ...
        case 3:
          viewingString = i18n.format(
            viewing2,
            members.viewing[0].name + ', ' + members.viewing[1].name + ',',
            members.viewing[2].name
          );
          break;
        default:
          viewingString = i18n.format(
    ...
    function getAllString(conversationID) {
      if (
        (viewing[conversationID] && viewing[conversationID].length > 3) ||
