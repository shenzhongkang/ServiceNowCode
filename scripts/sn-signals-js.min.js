...
!(function (t) {
      ...
      (t.exports = (function (t) {
            ...
            return function (n, c, v) {
              for (
                var d,
                  ...
                  m = u(x.length),
                  w = 0,
                  S = r ? p(n, m) : a ? p(n, 0) : void 0;
                m > w;
                w++
              )
                if ((h || w in x) && ((y = b((d = x[w]), w, g)), t))
                  if (r) S[w] = y;
                  else if (y)
                    switch (t) {
                      case 3:
        ...
        function (t, n, r) {
          ...
          if (r(8)) {
            var e = r(30),
              ...
              Tt = function () {
                return pt.apply(Nt ? lt.call(Et(this)) : Et(this), arguments);
              },
              Rt = {
              ...
              Dt = function (t, n) {
                return Wt(t, (n = x(n, !0))) ? l(2, t[n]) : B(t, n);
              },
              Gt = function (t, n, r) {
                return !(Wt(t, (n = x(n, !0))) && w(r) && b(r, 'value')) ||
                  b(r, 'get') ||
                  b(r, 'set') ||
                  r.configurable ||
                  ...
                  ? ((v = r(function (t, r, e, i) {
                      ...
                      if (w(r)) {
                        if (
                          ...
                          return bt in r ? Mt(v, r) : At.call(v, r);
                        (o = r), (p = Ot(e, n));
                        var g = r.byteLength;
                        if (void 0 === i) {
          ...
          t.exports = function (t, n, r, v, d, y, g) {
            ...
            if (
              (j &&
                ...
                m.next &&
                (f(m, S, !0), e || 'function' == typeof m[l] || u(m, l, p)),
              _ &&
                P &&
                'values' !== P.name &&
                ((O = !0),
        ...
        function (t, n, r) {
          ...
          function B(t, n, r, e, i, o) {
            ...
            for (var c = t[j]._b, a = u + t[I], f = e(+i), s = 0; s < n; s++)
              c[a + s] = f[o ? s : n - s - 1];
          }
          if (u.ABV) {
            if (
        ...
        function (t, n, r) {
          ...
          t.exports = function (t) {
            return function (n) {
              for (
                var r, c = o(n), a = i(c), f = a.length, s = 0, l = [];
                f > s;
        ...
        function (t, n, r) {
          ...
          var e = r(1),
            ...
            Z = function (t, n) {
              if (
                ((t = w(t)), (n = S(n, !0)), t !== B || !i(G, n) || i(U, n))
              ) {
                var r = A(t, n);
                return (
                  !r || !i(G, n) || (i(t, k) && t[k][n]) || (r.enumerable = !0),
                  r
                );
              }
            },
          ...
          V ||
            (c(
              (T = function () {
                ...
                return o && z && H(B, t, { configurable: !0, set: n }), Y(t);
              }).prototype,
              'toString',
              function () {
                return this._k;
            ...
            (r(45).f = K),
            (F.f = tt),
            o && !r(30) && c(B, 'propertyIsEnumerable', K, !0),
            (v.f = function (t) {
              return Y(p(t));
            })),
          ...
          for (
            ...
            p(nt[rt++]);
          for (var et = j(p.store), it = 0; et.length > it; ) d(et[it++]);
          u(u.S + u.F * !V, 'Symbol', {
            for: function (t) {
            ...
            return [
              ...
              function (t, n) {
                ...
                for (var m, w = '', S = 0, _ = 0; _ < x.length; _++) {
                  ...
                  } else A = d(O, h, E, P, M, n);
                  E >= S && ((w += h.slice(S, E) + A), (S = E + O.length));
                }
                return w + h.slice(S);
              },
            ];
                ...
                function (t, n) {
                  ...
                  var f = i(t),
                    ...
                    g =
                      ...
                      (f.unicode ? 'u' : '') +
                      (v ? 'y' : 'g'),
                    x = new p(v ? f : '^(?:' + f.source + ')', g),
                    b = void 0 === n ? 4294967295 : n >>> 0;
                  if (0 === b) return [];
                  if (0 === h.length) return null === a(x, h) ? [h] : [];
                  for (var m = 0, w = 0, S = []; w < h.length; ) {
                    x.lastIndex = v ? w : 0;
                    var _,
                      O = a(x, v ? h : h.slice(w));
                    if (
                      null === O ||
                      (_ = l(c(x.lastIndex + (v ? 0 : w)), h.length)) === m
                    )
                      w = u(h, w, y);
                    else {
                      if ((S.push(h.slice(m, w)), S.length === b)) return S;
        ...
        function (t, n, r) {
          ...
          var e,
            ...
            b = (t.exports = r(58)('WeakMap', g, x, f, !0, !0));
          h &&
            p &&
        ...
        function (t, n, r) {
          ...
          t.exports = function t(n, r, a, f, s, l, h, p) {
            for (var v, d, y = s, g = 0, x = !!h && u(h, p, 3); g < f; ) {
              if (g in a) {
                if (
                  ((v = x ? x(a[g], g, r) : a[g]),
                  (d = !1),
        ...
        function (t, n, r) {
          for (
            ...
            var y,
              ...
              b = u[g],
              m = b && b.prototype;
            if (m && (m[s] || c(m, s, h), m[l] || c(m, l, g), (a[g] = h), x))
        ...
        function (t, n, r) {
          var e = (function (t) {
            ...
            function b(t, n) {
              ...
              if ('throw' === e.type)
                return (
                  (n.method = 'throw'), (n.arg = e.arg), (n.delegate = null), f
                );
              var i = e.arg;
              return i
                ? i.done
        ...
        function (t, n, r) {
          var e = r(85),
            ...
            a = function (t, n, r) {
              ...
              for (f in (p && (r = n), r))
                ((s = !h && m && void 0 !== m[f]) && c(x, f)) ||
                  ((l = s ? m[f] : r[f]),
                  (x[f] =
                    p && 'function' != typeof m[f]
                      ? r[f]
                      : y && s
                      ? o(l, e)
                      : g && m[f] == l
        ...
        function (t, n, r) {
            ...
            s = function (t) {
              var n = t.eventAction,
                ...
                o = '?sysparm_event_action='
                  .concat(n, '&sysparm_event_priority=')
                  .concat(r);
              i.open('POST', '/api/now/analytics/events' + o),
                i.setRequestHeader('Content-Type', 'application/json'),
                window.g_ck && i.setRequestHeader('X-UserToken', g_ck),
          ...
          var d = {
            _location: {},
            priority: { INFO: 'INFO', WARN: 'WARN', ERROR: 'ERROR' },
            postContextProperty: function (t, n) {
              var r = new XMLHttpRequest(),
                e = {
                  sys_context_property_name: t,
                  sys_context_property_value: n,
                };
              r.open('POST', '/api/now/analytics/updateContext'),
                r.setRequestHeader('Content-Type', 'application/json'),
                window.g_ck && r.setRequestHeader('X-UserToken', g_ck),
                r.send(JSON.stringify(e));
            },
            trackEvent: function (t, n, r) {
              var e;
              !(function (t) {
                if ((c.push(t), 100 === c.length)) f();
                else {
                  if (a) return;
                ...
                eventBody: p(
                  ...
                  {
                    userSessionId:
                      window.NOW && window.NOW.session_id
                    ...
                    longitude: e.hasOwnProperty('longitude')
                      ? e.longitude
                      : null,
                  })
                ),
                  ...
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 3:
                          (n._location = t.sent),
                            n._location.hasOwnProperty('latitude') &&
                              n.postContextProperty(
                                'latitude',
                                n._location.latitude
                              ),
                            n._location.hasOwnProperty('longitude') &&
                              n.postContextProperty(
                                'longitude',
                                n._location.longitude
                              ),
                            (t.next = 10);
                          break;
                        case 8:
  ...
  function (t, n, r) {
    ...
    var e = r(0),
      i = r.n(e);
    window.GlideSignals = window.GlideSignals || i.a;
  },
]);
