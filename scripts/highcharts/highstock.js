...
(function (T, Q) {
    ...
    var da = (B.getStyle = function (c, l, x) {
      ...
      Y = (B.find = Array.prototype.find
        ...
        : function (c, l) {
            var x,
              a = c.length;
            for (x = 0; x < a; x++) if (l(c[x], x)) return c[x];
          });
    B.keys = function (c) {
      ...
      U = (B.removeEvent = function (c, l, x) {
        ...
        function e(x) {
          ...
          if (c.nodeName) {
            ...
            W(v, function (c, l) {
              if (x[l]) for (e = x[l].length; e--; ) a(l, x[l][e].fn);
            });
          }
        }
        var v;
  ...
  Q(
    ...
    function (k, t, I, D) {
      ...
      k = (function () {
        ...
        C.prototype.destroy = function () {
          ...
          for (
            ...
            x && x.div && 0 === x.div.childNodes.length;
      ...
      k.prototype.matrixSetter =
        k.prototype.rotationOriginXSetter =
        k.prototype.rotationOriginYSetter =
      ...
      C.prototype.symbols = {
        ...
        arc: function (a, c, l, e, f) {
          ...
          if (f) {
            ...
            x.push(
              ['M', a + g * E, c + l * v],
              ['A', g, l, 0, p, h(f.clockwise, 1), a + g * A, c + l * y]
            );
            d(e) &&
              x.push(
        ...
        htmlUpdateTransform: function () {
          if (this.added) {
            ...
            if ('SPAN' === n.tagName) {
              ...
              g !== this.cTT &&
                ((h = d.fontMetrics(n.style.fontSize, n).b),
                !J(q) ||
    ...
    function (k, t, I, D, J, M) {
      ...
      k = (function () {
        ...
        v.prototype.init = function (c, a) {
          ...
          e.crosshair = H(
            f.crosshair,
            P(c.options.tooltip.crosshairs)[l ? 0 : 1],
            !1
          );
          a = e.options.events;
          -1 === c.axes.indexOf(e) &&
              ...
              if (l.visible || !a.options.chart.ignoreHiddenSeries) {
                ...
                if (c.isXAxis) {
                  ...
                  f(l.dataMax) &&
                    ...
                    (c.dataMax = Math.max(H(c.dataMax, g), g))),
                  F(b) && (c.threshold = b),
                  !x.softThreshold || c.positiveValuesOnly)
                )
                  c.softThreshold = !1;
              }
            });
        ...
        v.prototype.getTitlePosition = function () {
          ...
          a =
            (c ? e + this.height : a) +
            (c ? 1 : -1) * (g ? -1 : 1) * this.axisTitleMargin +
            [-v, v, y.f, -v][this.side];
          c = {
        ...
        n = (function () {
          ...
          n.prototype.normalizeTimeTickInterval = function (n, d) {
            ...
            for (
              ...
              (u = M[d[0]]),
              (F = d[1]),
              k[w + 1] && n <= (u * F[F.length - 1] + M[k[w + 1][0]]) / 2);
              w++
            );
  ...
  Q(
    ...
    [k['Core/Axis/Axis.js'], k['Core/Globals.js'], k['Core/Utilities.js']],
    function (k, t, I) {
      var B = I.arrayMax,
        J = I.arrayMin,
        M = I.defined,
      ...
      var q = (function () {
        ...
        h.prototype.getPosition = function (b, g, f) {
          var a = this.chart,
            ...
            x = c('x'),
            r =
              !this.followPointer && w(f.ttBelow, !a.inverted === !!f.negative),
              ...
              : (this.split
                  ...
                  : ((b = this.getLabel()),
                    ...
                    y ||
                      b.attr({
                        stroke:
                          a.borderColor || p.color || d.color || '#666666',
                      }),
                    this.updatePosition({
                      plotX: g,
                      plotY: q,
        ...
        g = (function () {
          ...
          b.prototype.renderItem = function (a) {
            ...
            C ||
              ...
              (a.legendItem = C =
                e.text('', A ? g + h : -h, this.baseline || 0, x)),
            ...
            g &&
              [
                ...
                p.test(g) &&
                  ...
                  (e[h[d]] = Math.max(
                    e[h[d]],
                    e.legend[(d + 1) % 2 ? 'legendHeight' : 'legendWidth'] +
                      [1, -1, -1, 1][d] * f[d % 2 ? 'x' : 'y'] +
                      r(f.margin, 12) +
                      b[d] +
                      (e.titleOffset[d] || 0)
          ...
          b.prototype.handleOverflow = function (a) {
            ...
            a > h && !1 !== C.enabled
              ? ((this.clipHeight = q =
                  Math.max(h - 20 - this.titleHeight - d, 0)),
  ...
  Q(
    ...
    [k['Core/Globals.js'], k['Core/Series/Point.js'], k['Core/Utilities.js']],
    function (k, t, I) {
      var B = I.error,
        J = I.extendClass,
        M = I.fireEvent,
        ...
        U = (function () {
          ...
          n.prototype.isInsidePlot = function (a, c, e) {
            ...
            b = {
              ...
              y: a,
              isInsidePlot:
                0 <= b && b <= this.plotWidth && 0 <= a && a <= this.plotHeight,
            };
      ...
      return (k.LegendSymbolMixin = {
        ...
        drawLineMarker: function (k) {
          ...
          n &&
            ...
            (this.legendSymbol = n =
              O.symbol(this.symbol, z / 2 - t, k - t, 2 * t, 2 * t, n)
                .addClass('highcharts-point')
                .add(u)),
            (n.isMarker = !0));
        },
        ...
        },
        {
          ...
          updateData: function (a, b) {
            ...
            a.forEach(function (a, b) {
              ...
              if (h.id || e(x)) {
                if (
                  ((x = this.findPointIndex(h, p)),
                  -1 === x || 'undefined' === typeof x
                    ? g.push(a)
                    : l[x] && a !== c.data[x]
                    ? (l[x].update(a, !1, null, !1),
                      ...
                      A && (p = x + 1))
                    : l[x] && (l[x].touched = !0),
                  !v || b !== x || (f && f.enabled) || this.hasDerivedData)
                )
                  d = !0;
              } else g.push(a);
            }, this);
          ...
          getExtremes: function (c, b) {
            ...
            for (y = 0; y < l; y++) {
              ...
              C =
                ...
                ((d[y + v] || C) >= m && (d[y - v] || C) <= A);
              if (r && C)
                if ((r = E.length)) for (; r--; ) e(E[r]) && (h[p++] = E[r]);
                else h[p++] = E;
            }
          ...
          translate: function () {
            ...
            for (y = 0; y < v; y++) {
              ...
              P.plotX = H = r(
                w(
                  f.translate(t, 0, 0, 0, 1, C, 'flags' === this.type),
                  -1e5,
                  1e5
                )
              );
          ...
          animate: function (a) {
            ...
            if (!c.hasRendered)
              if (a) this.setClip(b);
                ...
                c[e + 'm'] &&
                  c[e + 'm'].animate(
                    { width: f.width + 99, x: f.x - (c.inverted ? 0 : 99) },
                    b
                  );
              }
          },
  ...
  Q(
    ...
    [k['Core/Series/CartesianSeries.js'], k['Core/Globals.js']],
    function (k, t) {
      t.Series = k;
      return t.Series;
    }
        ...
        F = (function () {
          function k(d, m, k, q, h) {
            ...
            this.alignOptions = {
              ...
              verticalAlign:
                m.verticalAlign || (b ? 'middle' : k ? 'bottom' : 'top'),
              y: m.y,
              x: m.x,
            };
            this.textAlign =
  ...
  Q(
    ...
    function (k, t, I, D, J, M, n, z, G, d) {
      ...
      g(t.prototype, {
        ...
        remove: function (b) {
          for (
            var e = this.chart, f = this.coll, c = this.series, g = c.length;
            g--;
          ...
          drawGraph: function () {
            ...
            t.forEach(function (u) {
              ...
              m
                ...
                : ((q.zIndex = 0),
                  (m = d[r] =
                    d.chart.renderer.path(k).addClass(u[1]).add(d.group)),
                  (m.isArea = !0));
              d.chart.styledMode ||
                (q.fill = z(
                  u[3],
  ...
  Q(
    ...
    [k['Core/Series/Series.js'], k['Core/Utilities.js']],
    function (k, t) {
      var B = t.pick;
      k.seriesType(
        'spline',
          ...
          drawPoints: function () {
            ...
            d.points.forEach(function (p) {
              ...
              if (w(p.plotY) && null !== p.y) {
                ...
                e ||
                  ((p.graphic = e =
                    g[p.shapeType](a).add(p.group || d.group)) &&
                    d.enabledDataSorting &&
                    h.hasRendered &&
                    h.pointCount < f &&
                ...
                h.styledMode ||
                  e[k](d.pointAttribs(p, p.selected && 'select')).shadow(
                    !1 !== p.allowShadow && b.shadow,
                    null,
  ...
  Q(
    ...
    [k['Core/Series/Series.js'], k['Core/Globals.js'], k['Core/Utilities.js']],
    function (k, t, I) {
      I = I.addEvent;
      var B = t.Series;
      k.seriesType(
        ...
        },
        {
          ...
          setVisible: function (b, g) {
            ...
            b !== f.visible &&
              ...
              (a.options.data[a.data.indexOf(f)] = f.options),
            ...
            a.targets.some(function () {
              ...
              if (
                ...
                return (
                  ...
                  k.reducedLen > 0.1 * g && t.distribute(k, g, f),
                  !0
                );
              b += k[d].size;
              d++;
      ...
      m(J.prototype, {
        ...
        setState: function (a, b) {
          ...
          if (
            ...
            if (g && !g.dashstyle)
              for (
                h = { 'stroke-width': m }, g.animate(h, q);
                e['zone-graph-' + f];
        ...
        function k(d, m, u, q) {
          ...
          n(d, function (b, g) {
            if (!q && -1 < t.collectionsWithUpdate.indexOf(g))
              for (
                b = G(b), u[g] = [], h = 0;
                h < Math.max(b.length, m[g].length);
                h++
              )
                m[g][h] &&
                  (void 0 === b[h]
        ...
        d.prototype.render = function (b, f, d, g) {
          ...
          if (!this.hasDragged || L(d)) {
            ...
            this.size =
              y =
              p =
                e(k.len, (u ? c.plotHeight : c.plotWidth) - 2 * h);
            c = u ? h : p + 2 * h;
          ...
          m.navigatorEnabled
            ...
            : ((m.xAxis = {
              ...
              (m.xAxis.navigatorAxis.toFixedRange =
                n.AdditionsClass.prototype.toFixedRange.bind(
        ...
        var u = (function () {
          ...
          d.prototype.getOverscrollPositions = function () {
            var d = this.axis,
              ...
              q = [],
              h = d.dataMax;
            if (z(n)) for (q.push(h); h <= d.dataMax + k; ) (h += n), q.push(h);
            return q;
          };
                ...
                (g && !1 !== g.visible) || (g = n[h + 1]),
                  ...
                  !1 !== g.visible &&
                    ...
                    (g.x - k.x > d &&
                      ...
                      b.stacking &&
                        this.options.stacking &&
                        ((g = b.stacking.stacks[this.stackKey][g] =
                          new I(b, b.options.stackLabels, !1, g, this.stack)),
                        (g.total = 0))),
                    (g = k));
            ...
            for (
              ...
              f.pointClass &&
                ...
                ((f.dataGroupInfo.options = L(
                  f.pointClass.prototype.optionsToObject.call(
                    { series: f },
  ...
  Q(
    ...
    [k['Core/Series/Series.js'], k['Core/Series/Point.js']],
    function (k, t) {
      var B = k.seriesTypes;
      k.seriesType(
        'ohlc',
  ...
  Q(
    ...
    [k['Core/Series/Series.js'], k['Core/Options.js'], k['Core/Utilities.js']],
    function (k, t, I) {
      t = t.defaultOptions;
      I = I.merge;
            ...
            k.points.forEach(function (z) {
              ...
              if ('undefined' !== typeof z.plotY) {
                ...
                D.push(
                  ...
                  ['Z'],
                  ['M', u, r],
                  ['L', u, w ? Math.round(n ? z.yBottom : z.plotHigh) : r],
                  ['M', u, F],
                  ['L', u, I ? Math.round(n ? z.plotHigh : z.yBottom) : F]
                );
          ...
          drawPoints: function () {
            ...
            for (e = h.length; e--; ) {
              ...
              'undefined' !== typeof v && 0 <= B && !z
                ? (A ||
                    ((A = r.graphic =
                      g.label('', null, null, C, null, null, a.useHTML)),
                    b.styledMode ||
      ...
      var f = (function () {
        ...
        a.prototype.render = function (a, b) {
          ...
          if (!1 !== r.enabled) {
            e.rendered ||
              ((e.group = I =
                f.g('range-selector-group').attr({ zIndex: 7 }).add()),
            ...
            G.align(
              { y: u.y, width: G.getBBox().width, align: u.align, x: g },
              !0,
              d.spacingBox
            );
            e.group.placed = T;
            ...
            !1 !== z &&
              ...
              (w.align === u.align ||
                ...
                q.attr({
                  translateX:
                    q.alignAttr.translateX + (d.axisOffset[1] >= -X ? 0 : -X),
