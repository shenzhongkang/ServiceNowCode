        ...
        { colorByPoint: !0, dataLabels: { y: 0 } },
        {
            ...
            a.points.forEach(function (f) {
              if (!f.isNull) {
                var d = f.graphic,
                  ...
                  n =
                    (y(v(f.options.innerRadius, b.innerRadius, 60)) * l[2]) /
                    200,
                  p = c.toColor(f.y, f),
                ...
                f.startR = h;
                d
                  ? ((h = n.d), d.animate(w({ fill: p }, n)), h && (n.d = h))
                  : (f.graphic = d =
                      k.arc(n).attr({ fill: p, 'sweep-flag': 0 }).add(a.group));
                a.chart.styledMode ||
                  ('square' !== b.linecap &&
                    d.attr({
          ...
          animate: function (a) {
            a ||
              ...
              m.seriesTypes.pie.prototype.animate.call(this, a));
          },
        }
      );
      ('');
