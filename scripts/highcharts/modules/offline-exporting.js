...
(function (a) {
  ...
  f(a, 'Extensions/DownloadURL.js', [a['Core/Globals.js']], function (a) {
    ...
    a = a.downloadURL = function (a, f) {
      ...
      if ('string' === typeof a || a instanceof String || !m.msSaveOrOpenBlob) {
        ...
        if ('undefined' !== typeof d.download)
          (d.href = a),
            (d.download = f),
  ...
  f(
    a,
    'Extensions/OfflineExporting.js',
    [
    ...
    function (a, b, f, e, L) {
      ...
      function m(a) {
        var b =
          -1 < v.userAgent.indexOf('WebKit') &&
          0 > v.userAgent.indexOf('Chrome');
        try {
          if (!b && 0 > v.userAgent.toLowerCase().indexOf('firefox'))
            return G.createObjectURL(
              new d.Blob([a], { type: 'image/svg+xml;charset-utf-16' })
            );
        } catch (g) {}
      ...
      function C(a, b, g, c) {
        function f(a, b) {
          ...
          [].forEach.call(
            a.querySelectorAll('*[visibility="hidden"]'),
            function (a) {
              a.parentNode.removeChild(a);
            }
          );
          d.svg2pdf(a, c, { removeInvalid: !0 });
        ...
        else if ('application/pdf' === h)
          d.jsPDF && d.svg2pdf
            ? n()
            : ((e = !0),
              u(p + 'jspdf.js', function () {
            ...
            function () {
              var b = k.createElement('canvas'),
                ...
                l = function () {
                  n.drawSvg(a, 0, 0, f, y);
                  try {
                    z(v.msSaveOrOpenBlob ? b.msToBlob() : b.toDataURL(h), r),
                      c && c();
                  } catch (O) {
                    g(O);
                  } finally {
      ...
      a.prototype.getSVGForLocalExport = function (a, b, d, c) {
        ...
        try {
          ...
          for (l = q.length; t < l; ++t) {
            var m = q[t];
            (h = m.getAttributeNS('http://www.w3.org/1999/xlink', 'href'))
              ? x(h, 'image/png', { imageElement: m }, a.scale, r, d, d, d)
              : (++n, m.parentNode.removeChild(m), k());
          }
        } catch (w) {
          d(w);
        }
      ...
      a.prototype.exportChartLocal = function (a, b) {
        ...
        a = function () {
          return [].some.call(
            d.container.getElementsByTagName('image'),
            function (a) {
        ...
        (B &&
          ('application/pdf' === c.type ||
            (d.container.getElementsByTagName('image').length &&
              'image/svg+xml' !== c.type))) ||
        ('application/pdf' === c.type && a())
          ? e('Image type not supported for this chart/browser.')
          : d.getSVGForLocalExport(c, b, e, function (a) {
              -1 < a.indexOf('<foreignObject') && 'image/svg+xml' !== c.type
                ? e('Image type not supportedfor charts with embedded HTML')
                : C(a, P({ filename: d.getFilename() }, c), e);
            });
      };
      K(!0, J().exporting, {
