...
function nextCalendarAction(
  ...
  if (form) {
    ...
    if (viewwidget) url += '&sysparm_view=' + viewwidget.value;
    window.location = url;
  } else {
      ...
      if (typeof $j != 'undefined' && calendarID != null && calendarID.length) {
        ...
        if (content.length) {
          ...
          if (!cstyle) {
            ...
            if (media != null) cstyle = media.value;
          }
    ...
    if (form != null) {
      ...
      url += '&sysparm_month=' + month;
      url += '&sysparm_day=' + day;
      if (styleField) url += '&sysparm_calstyle=' + styleField;
      window.location = url;
    }
  }
}
