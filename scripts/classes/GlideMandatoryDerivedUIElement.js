...
var GlideMandatoryDerivedUIElement = Class.create(GlideUIElement, {
  initialize: function (
    ...
    if (this.mandatoryDerived) {
      ...
      if (e) e.setAttribute('mandatory', mandatory);
    }
    this.referenceField;
  },
  ...
  isMandatoryByReferenceField: function () {
    return this.referenceField &&
      (this.referenceField.isMandatory() || this.referenceField.getValue())
      ? true
      : false;
  },
  ...
  _isDisabled: function () {
    ...
    if (control.getAttribute('derived-waiting') === 'true') return false;
    return (
      control.disabled ||
      control.readOnly ||
