      ...
      if (parentCache) {
          ...
          if (table) {
              try {
                  ...
                  console.warn("An error occurred with the Table object or the callback applied to the Table object. " + "Due to limitations in IE11 this is expected when the form is inside the frameset and is " + "refreshed (saved, updated,  etc) and should not affect functionality.", error);
              }
          }
      }
  }
