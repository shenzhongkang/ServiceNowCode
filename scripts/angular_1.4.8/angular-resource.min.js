      ...
      function (k, F) {
              ...
              n = k(v).then(
                function (b) {
                  var c = b.data,
                    m = p.$promise;
                  if (c) {
                    if (f.isArray(c) !== !!a.isArray)
                      throw y(
                        'badcfg',
                        q,
                        a.isArray ? 'array' : 'object',
                        f.isArray(c) ? 'array' : 'object',
                        v.method,
                        v.url
                      );
                    a.isArray
        ...
        w.prototype = {
          setUrlParams: function (l, g, e) {
            ...
            h.defaults.stripTrailingSlashes &&
              (c = c.replace(/\/+$/, '') || '/');
            c = c.replace(/\/\.(?=\w+($|\?))/, '.');
            l.url = r + c.replace(/\/\\\./, '/.');
            u(g, function (a, c) {
              h.urlParams[c] ||
                ((l.params = l.params || {}), (l.params[c] = a));
            });
          },
        };
        return z;
