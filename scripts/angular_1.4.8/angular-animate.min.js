...
(function (H, u, Sa) {
  ...
  function Q(a, b, c) {
    ...
    c.preparationClasses &&
      ((b.preparationClasses = Y(c.preparationClasses, b.preparationClasses)),
  ...
  var M = u.noop,
    ...
    U,
    ta;
  qa(H.ontransitionend) && V(H.onwebkittransitionend)
    ? ((O = 'WebkitTransition'), (sa = 'webkitTransitionEnd transitionend'))
    : ((O = 'transition'), (sa = 'transitionend'));
  qa(H.onanimationend) && V(H.onwebkitanimationend)
    ? ((U = 'WebkitAnimation'), (ta = 'webkitAnimationEnd animationend'))
    : ((U = 'animation'), (ta = 'animationend'));
  var ka = U + 'Delay',
    ua = U + 'Duration',
    fa = O + 'Delay';
  H = O + 'Duration';
          ...
          function (d, s, h, g, v, r, $, u, R, C) {
            ...
            function K(a, b, c) {
              ...
              (a = t[c]) &&
                q(a, function (a) {
                  a.node.contains(f)
                    ? n.push(a.callback)
                    : 'leave' === c && a.node.contains(d) && n.push(a.callback);
                });
              return n;
            }
            function l(a, f, k) {
              ...
              function t(b) {
                ...
                f.activeClasses &&
                  (c.removeClass(f.activeClasses), (f.activeClasses = null));
                Ha(a, k);
                da(a, k);
                k.domOperation();
                h.complete(!b);
            ...
            function la(a, b, c) {
              ...
              for ((a = a.data('$ngAnimatePin')) && (b = a); b && b.length; ) {
                ...
                if (qa(w) || !0 === w)
                  (a = b.data('$$ngAnimateChildren')), V(a) && (w = a);
                if (n && !1 === w) break;
                t ||
                  ((t = f(b, h)),
          ...
          function (a, e, s, h, g, v) {
            function r(a) {
              ...
              for (d = 0; d < a.length; d++) {
                ...
                e.put(
                  h.domNode,
                  (a[d] = { domNode: h.domNode, fn: h.fn, children: [] })
                );
              }
    ...
    .provider('$animateCss', [
      ...
      function (a) {
        ...
        this.$get = [
          ...
          '$$rAFScheduler',
          '$animate',
          function (a, e, s, h, g, v, r, u) {
            function Ga(a, b) {
              var c = a.parentNode;
              return (
                (c.$$ngAnimateParentKey || (c.$$ngAnimateParentKey = ++l)) +
                '-' +
            ...
            return function (a, c) {
              ...
              function A() {
                function b() {
                  if (!ga) {
                    ...
                    if (l.length) {
                      var G = l[0];
                      (r = k > G.expectedEndTime)
                        ? h.cancel(G.timer)
                        : l.push(m);
                    }
                    r &&
                      ((v = h(d, v, !1)),
                      (l[0] = { timer: v, expectedEndTime: k }),
                      l.push(m),
                      a.data('$$animateCss', l));
                    a.on(x.join(' '), g);
                    c.to &&
                      (c.cleanupStyles && Ea(t, n, Object.keys(c.to)),
                      za(a, c));
                  }
                }
                function d() {
                ...
                if (!ga)
                  if (n.parentNode) {
                    var A,
                      ...
                      v =
                        0 < V &&
                        ((E.transitionDuration && 0 === S.transitionDuration) ||
                          (E.animationDuration && 0 === S.animationDuration)) &&
                        Math.max(S.animationDelay, S.transitionDelay);
              ...
              c.removeClass &&
                (P.length && (P += ' '), (P += T(c.removeClass, '-remove')));
              ...
              c.transitionStyle &&
                ((l = [O, c.transitionStyle]), ea(n, l), y.push(l));
              0 <= c.duration &&
                ((l = 0 < n.style[O].length),
                (l = Ca(c.duration, l)),
                ea(n, l),
                y.push(l));
              c.keyframeStyle &&
                ((l = [U, c.keyframeStyle]), ea(n, l), y.push(l));
              var V = S
                ? 0 <= c.staggerIndex
                  ? c.staggerIndex
                  : b.count(aa)
              ...
              p.hasAnimations = 0 < E.animationDuration;
              p.hasTransitionAll =
                p.hasTransitions && 'all' == E.transitionProperty;
              ...
              p.applyTransitionDelay =
                oa(c.delay) && (p.applyTransitionDuration || p.hasTransitions);
              ...
              z = 1e3 * J;
              c.skipBlocking ||
                ((p.blockTransition = 0 < E.transitionDuration),
                (p.blockKeyframeAnimation =
                  0 < E.animationDuration &&
                  0 < S.animationDelay &&
                  0 === S.animationDuration));
              c.from &&
                (c.cleanupStyles && Ea(t, n, Object.keys(c.from)), ya(a, c));
              p.blockTransition || p.blockKeyframeAnimation
                ? F(J)
                : c.skipBlocking || ja(n, !1);
              return {
                $$willAnimate: !0,
                end: d,
                start: function () {
                  if (!ga)
                    return (
                      (L = { end: d, cancel: g, resume: null, pause: null }),
                      (H = new s(L)),
                      C(A),
                      H
                    );
      ...
      function (a) {
        ...
        this.$get = [
          ...
          function (a, c, d, e, s, h, g) {
            ...
            return function (a) {
              return a.from && a.to
                ? H(a.from, a.to, a.classes, a.anchors)
                : R(a);
            };
          },
        ];
          ...
          function (b, c, d) {
            ...
            return function (a, b, d, r) {
              ...
              function H(a, b, d, e, f) {
                ...
                b.push(e);
                if ((a = a.apply(a, b)))
                  if ((Fa(a.start) && (a = a.start()), a instanceof c))
                    a.done(f);
              ...
              function C(a, b, d, e, f) {
                ...
                if (0 === g.length) {
                  var h, l;
                  'beforeSetClass' === f
                    ? ((h = B(a, 'removeClass', d, e, 'beforeRemoveClass')),
                      (l = B(a, 'addClass', d, e, 'beforeAddClass')))
                    : 'setClass' === f &&
                      ((h = B(a, 'removeClass', d, e, 'removeClass')),
              ...
              if (l.length) {
                ...
                'leave' == b
                  ...
                  : ((I = 'before' + b.charAt(0).toUpperCase() + b.substr(1)),
                    (f = b));
