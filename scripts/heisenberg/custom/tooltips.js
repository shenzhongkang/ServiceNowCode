...
(function ($) {
  ...
  var SN_TOOLTIP_SELECTOR =
    '.sn-tooltip-basic, *[title]:not(.accessibility_no_tooltip), *[data-dynamic-title]:not(.accessibility_no_tooltip), [data-tooltip-overflow-only="true"]';
  $(function () {
    ...
    (function setupTooltips() {
      $tooltips.each(function () {
        ...
        if (
          ...
          !this.hasAttribute('data-original-title')
        )
    ...
    $(document.body).on(
      ...
      SN_TOOLTIP_SELECTOR,
      function (evt) {
        if (this.tagName == 'IFRAME' || this.tagName == 'OPTION') return;
        var $this = $(this);
        var $target = $(evt.target);
        if ($this.data('bs.tooltip')) return;
        if (
          this.getAttribute('data-tooltip-overflow-only') === 'true' &&
          !this.hasAttribute('title')
        ) {
        ...
        if (
          ...
          typeof g_accessibility_tooltip_duration !== 'undefined'
        )
    ...
    $(document).bind('mouseleave', function (evt) {
      ...
      $('.sn-tooltip-basic, *[title]').each(function () {
        ...
        var $this = $(this);
        if ($this.data('bs.tooltip')) $this.tooltip('hide');
      });
    });
  });
})(jQuery);