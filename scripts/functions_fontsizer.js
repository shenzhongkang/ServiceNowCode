...
function setPreferredFontSize(increment) {
  var ruleStart =
    'BODY, TABLE, INPUT, SELECT, BUTTON, INPUT.TEXT, TEXTAREA, INPUT.button {font-size: ';
  var ruleEnd = '}';
  var t = g_fontSize;
  if (g_fontSizePreference) t = g_fontSizePreference;
  var t = t.split('p')[0];
  ...
  if (increment) {
    ...
    if (e) e.innerHTML = '(' + g_fontSizePreference + ')';
  }
