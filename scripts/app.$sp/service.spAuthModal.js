        ...
        glideUserSession
          ...
          .then(function (user) {
            ...
            if (cabrillo.isNative()) {
              cabrillo.auth.reauthenticate(currentUser).then(
                function () {
              ...
              spModal
                .open({
                  ...
                  message: i18n.getMessage(
                    'Additional authentication is required, enter your usename and password to continue.'
                  ),
      ...
      function onLoginModalSubmit(requestParams, username) {
        return $q(function (resolve, reject) {
          ...
          if (
            ...
            requestParams.username.trim() === '' ||
            !requestParams.password ||
            requestParams.password.trim() === ''
          ) {
            ...
            errorMessage = i18n.getMessage(
              'Attempted to authenticate as a different user'
            );
          }
          if (!errorMessage || errorMessage === '') {
            spAuthentication
              .validateCreds(requestParams.username, requestParams.password)
              .then(function (res) {
