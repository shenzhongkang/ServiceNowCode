...
angular
  .module('sn.$sp')
  .factory('spAuthentication', function ($window, $q, $http, spUtil, i18n) {
    'use strict';
    var genericError = i18n.getMessage(
    ...
    function _validate(username, password) {
      if (username !== sessionUsername) {
        return _error(
          i18n.getMessage(
            'Specified username does not match with the username of currently logged in user'
          )
        );
      }
