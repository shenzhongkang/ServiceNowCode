/*! RESOURCE: /scripts/service-portal-designer/libs/min/jquery-ui-1.12.1.min.js */
...
!(function (t) {
  ...
  (P.cleanData =
    ...
    (P.widget = function (t, i, e) {
      ...
      return (
        ...
        (o.prototype = P.widget.extend(
          n,
          { widgetEventPrefix: (s && n.widgetEventPrefix) || t },
          r,
          { constructor: o, namespace: h, widgetName: t, widgetFullName: a }
        )),
        s
        ...
        for (e in s[o])
          (i = s[o][e]),
            s[o].hasOwnProperty(e) &&
              void 0 !== i &&
              (P.isPlainObject(i)
                ? (t[e] = P.isPlainObject(t[e])
                    ? P.widget.extend({}, t[e], i)
                    : P.widget.extend({}, i))
                : (t[e] = i));
      return t;
    }),
    ...
    (P.Widget.prototype = {
      ...
      option: function (t, e) {
        ...
        if ('string' == typeof t)
          if (((n = {}), (t = (i = t.split('.')).shift()), i.length)) {
            for (
              s = n[t] = P.widget.extend({}, this.options[t]), o = 0;
              o < i.length - 1;
              o++
            )
              (s[i[o]] = s[i[o]] || {}), (s = s[i[o]]);
        ...
        function t(t, e) {
          for (var i, s = 0; s < t.length; s++)
            (i = r.classesElementLookup[t[s]] || P()),
              (i = o.add
                ? P(P.unique(i.get().concat(o.element.get())))
                : P(i.not(o.element).get())),
      ...
      _untrackClassesElement: function (i) {
        ...
        P.each(s.classesElementLookup, function (t, e) {
          -1 !== P.inArray(i.target, e) &&
            (s.classesElementLookup[t] = P(e.not(i.target).get()));
        });
      },
      ...
      _on: function (o, n, t) {
        ...
        'boolean' != typeof o && ((t = n), (n = o), (o = !1)),
          t
            ? ((n = r = P(n)), (this.bindings = this.bindings.add(n)))
            ...
            function i() {
              if (
                ...
                (!0 !== h.options.disabled &&
                  !P(this).hasClass('ui-state-disabled'))
              )
                return ('string' == typeof e ? h[e] : e).apply(h, arguments);
            }
            'string' != typeof e &&
              (i.guid = e.guid = e.guid || i.guid || P.guid++);
            var s = t.match(/^([\w:-]*)\s*(.*)$/),
    ...
    P.each({ show: 'fadeIn', hide: 'fadeOut' }, function (n, r) {
      P.Widget.prototype['_' + n] = function (e, t, i) {
        ...
        (t.complete = i),
          ...
          o && P.effects && P.effects.effect[s]
            ? e[n](t)
            : s !== n && e[s]
  ...
  (C = Math.max),
    ...
    (P.position = {
      ...
      getWithinInfo: function (t) {
        ...
        return {
          ...
          isWindow: i,
          isDocument: s,
          offset: !i && !s ? P(t).offset() : { left: 0, top: 0 },
    ...
    (P.fn.position = function (u) {
      ...
      var f,
        ...
        t,
        v = P(u.of),
        _ = P.position.getWithinInfo(u.within),
        w = P.position.getScrollInfo(_),
      ...
      return (
        ...
        this.each(function () {
          var i,
            ...
            e = H(this, 'marginLeft'),
            s = H(this, 'marginTop'),
            o = h + e + H(this, 'marginRight') + w.width,
            n = a + s + H(this, 'marginBottom') + w.height,
            l = P.extend({}, g),
            c = W(b.my, r.outerWidth(), r.outerHeight());
          'right' === u.my[0]
            ? (l.left -= h)
            : 'center' === u.my[0] && (l.left -= h / 2),
            'bottom' === u.my[1]
              ? (l.top -= a)
              : 'center' === u.my[1] && (l.top -= a / 2),
            (l.left += c[0]),
            (l.top += c[1]),
            (i = { marginLeft: e, marginTop: s }),
            P.each(['left', 'top'], function (t, e) {
              P.ui.position[y[t]] &&
                P.ui.position[y[t]][e](l, {
                  targetWidth: p,
                  targetHeight: d,
                  elemWidth: h,
                  elemHeight: a,
            ...
            u.using &&
              (t = function (t) {
                ...
                p < h && I(e + i) < p && (n.horizontal = 'center'),
                  d < a && I(s + o) < d && (n.vertical = 'middle'),
                  C(I(e), I(i)) > C(I(s), I(o))
                    ? (n.important = 'horizontal')
                    : (n.important = 'vertical'),
                  u.using.call(this, t, n);
              }),
            r.offset(P.extend(l, { using: t }));
        })
      );
    }),
    (P.ui.position = {
        ...
        left: function (t, e) {
          ...
          e.collisionWidth > o
            ? 0 < r && h <= 0
              ...
              : (t.left =
                  !(0 < h && r <= 0) && h < r ? s + o - e.collisionWidth : s)
            : 0 < r
            ? (t.left += r)
            : 0 < h
            ? (t.left -= h)
            : (t.left = C(t.left - n, t.left));
        },
        top: function (t, e) {
          var i = e.within,
          ...
          e.collisionHeight > o
            ? 0 < r && h <= 0
              ...
              : (t.top =
                  !(0 < h && r <= 0) && h < r ? s + o - e.collisionHeight : s)
            : 0 < r
            ? (t.top += r)
            : 0 < h
            ? (t.top -= h)
            : (t.top = C(t.top - n, t.top));
        },
      },
      flip: {
        left: function (t, e) {
          var i = e.within,
            ...
            r = -2 * e.offset[0];
          h < 0
            ? ((s = t.left + l + i + r + e.collisionWidth - o - s) < 0 ||
                s < I(h)) &&
              (t.left += l + i + r)
            : 0 < a &&
              (0 <
                (n = t.left - e.collisionPosition.marginLeft + l + i + r - n) ||
                I(n) < a) &&
              (t.left += l + i + r);
        },
        top: function (t, e) {
          var i = e.within,
            ...
            r = -2 * e.offset[1];
          h < 0
            ? ((s = t.top + l + i + r + e.collisionHeight - o - s) < 0 ||
                s < I(h)) &&
              (t.top += l + i + r)
            : 0 < a &&
              (0 <
                (n = t.top - e.collisionPosition.marginTop + l + i + r - n) ||
                I(n) < a) &&
              (t.top += l + i + r);
        },
      },
    ...
    return 'area' === r
      ? ((s = (i = t.parentNode).name),
        !(!t.href || !s || 'map' !== i.nodeName.toLowerCase()) &&
          0 < (s = P("img[usemap='#" + s + "']")).length &&
          s.is(':visible'))
      : (/^(input|select|textarea|button|object)$/.test(r)
          ? (o = !t.disabled) &&
            (n = P(t).closest('fieldset')[0]) &&
            (o = !n.disabled)
          : (o = ('a' === r && t.href) || e),
        o &&
          P(t).is(':visible') &&
  ...
  '1.7' === P.fn.jquery.substring(0, 3) &&
    (P.each(['Width', 'Height'], function (t, i) {
      ...
      function r(t, e, i, s) {
        return (
          P.each(o, function () {
            (e -= parseFloat(P.css(t, 'padding' + this)) || 0),
              i && (e -= parseFloat(P.css(t, 'border' + this + 'Width')) || 0),
              s && (e -= parseFloat(P.css(t, 'margin' + this)) || 0);
          }),
          e
        );
      }
      (P.fn['inner' + i] = function (t) {
        return void 0 === t
          ? n['inner' + i].call(this)
          : this.each(function () {
              P(this).css(s, r(this, t) + 'px');
            });
      }),
        (P.fn['outer' + i] = function (t, e) {
          return 'number' != typeof t
            ? n['outer' + i].call(this, t)
            : this.each(function () {
                P(this).css(s, r(this, t, !0, e) + 'px');
              });
        });
    }),
  ...
  (P.ui.keyCode = {
      ...
      return this[0].labels && this[0].labels.length
        ...
        : ((e = this.eq(0).parents('label')),
          (t = this.attr('id')) &&
            ...
            (t = "label[for='" + P.ui.escapeSelector(t) + "']"),
    ...
    (P.fn.scrollParent = function (t) {
      ...
      return 'fixed' !== e && t.length
        ? t
        : P(this[0].ownerDocument || document);
    }),
    P.extend(P.expr[':'], {
      tabbable: function (t) {
    ...
    _mouseInit: function () {
      ...
      this.element
        ...
        .on('click.' + this.widgetName, function (t) {
          if (!0 === P.data(t.target, e.widgetName + '.preventClickEvent'))
            return (
              P.removeData(t.target, e.widgetName + '.preventClickEvent'),
      ...
      if (!f) {
        ...
        var e = this,
          ...
          s =
            ...
            P(t.target).closest(this.options.cancel).length;
        return i && !s && this._mouseCapture(t)
          ? ((this.mouseDelayMet = !this.options.delay),
            ...
            !this._mouseStarted)
              ? (t.preventDefault(), !0)
              : (!0 ===
                  P.data(t.target, this.widgetName + '.preventClickEvent') &&
                  P.removeData(
                    t.target,
      ...
      this.document
        ...
        this._mouseStarted &&
          ...
          t.target === this._mouseDownEvent.target &&
            P.data(t.target, this.widgetName + '.preventClickEvent', !0),
          this._mouseStop(t)),
    ...
    P.widget('ui.sortable', P.ui.mouse, {
      ...
      _mouseCapture: function (t, e) {
        ...
        return (
          ...
          P(t.target)
            .parents()
            .each(function () {
              if (P.data(this, o.widgetName + '-item') === o)
                return (i = P(this)), !1;
            }),
          !!(i =
            P.data(t.target, o.widgetName + '-item') === o ? P(t.target) : i) &&
            !(
              this.options.handle &&
              !e &&
                ...
                ? (this.overflowOffset.top +
                  ...
                  n.scrollSensitivity
                    ...
                    : t.pageX - this.overflowOffset.left <
                      ...
                      (this.scrollParent[0].scrollLeft = r =
                        this.scrollParent[0].scrollLeft - n.scrollSpeed))
                : (t.pageY - this.document.scrollTop() < n.scrollSensitivity
                  ...
                  t.pageX - this.document.scrollLeft() < n.scrollSensitivity
      ...
      _intersectsWith: function (t) {
        ...
        return 'pointer' === this.options.tolerance ||
          ...
          ? l && c
          : n < e + this.helperProportions.width / 2 &&
      ...
      _getItemsAsjQuery: function (t) {
        ...
        if (h && t)
          for (e = h.length - 1; 0 <= e; e--)
            for (i = (s = P(h[e], this.document[0])).length - 1; 0 <= i; i--)
              (o = P.data(s[i], this.widgetFullName)) &&
                o !== this &&
                !o.options.disabled &&
                r.push([
                  P.isFunction(o.options.items)
                    ? o.options.items.call(o.element)
                    : P(o.options.items, o.element)
      ...
      _contactContainers: function (t) {
        for (
          ...
          P.contains(this.currentItem[0], this.containers[f].element[0]) ||
            (this._intersectsWith(this.containers[f].containerCache)
              ? (c &&
                  P.contains(this.containers[f].element[0], c.element[0])) ||
                ((c = this.containers[f]), (u = f))
