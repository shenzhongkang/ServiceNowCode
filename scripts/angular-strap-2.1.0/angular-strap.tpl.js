/*! RESOURCE: /scripts/angular-strap-2.1.0/angular-strap.tpl.js */
(function (window, document, undefined) {
  ...
  angular.module('mgcrea.ngStrap.tab').run([
    ...
    function ($templateCache) {
      $templateCache.put(
        'tab/tab.tpl.html',
        '<ul class="nav" ng-class="$navClass" role="tablist"><li ng-repeat="$pane in $panes" ng-class="$index == $panes.$active ? $activeClass : \'\'"><a role="tab" data-toggle="tab" ng-click="$setActive($index)" data-index="{{ $index }}" ng-bind-html="$pane.title"></a></li></ul><div ng-transclude class="tab-content"></div>'
      );
    },
  ]);
