...
/*! jQuery v2.2.3-snc | (c) jQuery Foundation | jquery.org/license */
!(function (a, b) {
    ...
    function (a, b) {
      n.fn[a] = function (c, d) {
        ...
        return (
          ...
          this.length > 1 &&
            (D[a] || n.uniqueSort(e), C.test(a) && e.reverse()),
          this.pushStack(e)
        );
      };
    }
              ...
              function (b) {
                ...
                if (f && void 0 === b) {
                  if (
                    ...
                    (c =
                      N.get(f, a) ||
                      N.get(f, a.replace(P, '-$&').toLowerCase()))
                  )
                    return c;
                  if (((d = n.camelCase(a)), void 0 !== (c = N.get(f, d))))
                    return c;
                  if (void 0 !== (c = Q(f, d, void 0))) return c;
                } else
                  (d = n.camelCase(a)),
                    this.each(function () {
                      var c = N.get(this, d);
  ...
  function ba(a, b, c, d, e) {
    ...
    while ((f = m[o++]))
      if (d && n.inArray(f, d) > -1) e && e.push(f);
        ...
        (g = $(l.appendChild(f), 'script')),
        j && _(g),
        c)
      ) {
        k = 0;
        while ((f = g[k++])) Y.test(f.type || '') && c.push(f);
      }
    return l;
  }
  !(function () {
  ...
  var ca = /^key/,
    da = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
    ea = /^([^.]*)(?:\.(.+)|)/;
  function fa() {
    return !0;
  }
  ...
  (n.event = {
    ...
    fix: function (a) {
      ...
      h ||
        (this.fixHooks[f] = h =
          da.test(f) ? this.mouseHooks : ca.test(f) ? this.keyHooks : {}),
    ...
    special: {
      ...
      focus: {
        trigger: function () {
          if (this !== ha() && this.focus) return this.focus(), !1;
        },
        delegateType: 'focusin',
      },
      blur: {
        trigger: function () {
          if (this === ha() && this.blur) return this.blur(), !1;
        },
    ...
    (n.Event.prototype = {
      ...
      preventDefault: function () {
        ...
        (this.isDefaultPrevented = fa), a && a.preventDefault();
      },
      stopPropagation: function () {
        var a = this.originalEvent;
        (this.isPropagationStopped = fa), a && a.stopPropagation();
      },
  ...
  function ta(a, b, c, d) {
    ...
    var e,
      ...
      q = b[0],
      r = n.isFunction(q);
    if (r || (o > 1 && 'string' == typeof q && !l.checkClone && la.test(q)))
      return a.each(function (e) {
        var f = a.eq(e);
        r && (b[0] = q.call(this, e, f.html())), ta(f, b, c, d);
      });
    if (
      o &&
      ((e = ba(b, a[0].ownerDocument, !1, a, d)),
      (g = e.firstChild),
      1 === e.childNodes.length && (e = g),
      g || d)
    ) {
      for (h = n.map($(e, 'script'), pa), i = h.length; m < o; m++)
        (j = e),
          m !== p &&
            ((j = n.clone(j, !0, !0)), i && n.merge(h, $(j, 'script'))),
          c.call(a[m], j, m);
      if (i)
        for (k = h[h.length - 1].ownerDocument, n.map(h, qa), m = 0; m < i; m++)
          (j = h[m]),
            Y.test(j.type || '') &&
              ...
              (j.src
                ...
                : n.globalEval(j.textContent.replace(na, '')));
    }
    return a;
  }
  function ua(a, b, c) {
    for (var d, e = b ? n.filter(b, a) : a, f = 0; null != (d = e[f]); f++)
      c || 1 !== d.nodeType || n.cleanData($(d)),
        d.parentNode &&
          (c && n.contains(d.ownerDocument, d) && _($(d, 'script')),
          d.parentNode.removeChild(d));
    return a;
  }
  n.extend({
    htmlPrefilter: function (a) {
      return a.replace(ja, '<$1></$2>');
    },
    clone: function (a, b, c) {
      ...
      if (
        ...
        for (g = $(h), f = $(a), d = 0, e = f.length; d < e; d++)
          sa(f[d], g[d]);
      if (b)
        if (c)
          for (f = f || $(a), g = g || $(h), d = 0, e = f.length; d < e; d++)
            ra(f[d], g[d]);
        else ra(a, h);
      return (
        (g = $(h, 'script')), g.length > 0 && _(g, !i && $(a, 'script')), h
      );
    },
    cleanData: function (a) {
      for (var b, c, d, e = n.event.special, f = 0; void 0 !== (c = a[f]); f++)
        if (K(c)) {
          ...
          c[N.expando] && (c[N.expando] = void 0);
        }
    },
  }),
    n.fn.extend({
      ...
      empty: function () {
        for (var a, b = 0; null != (a = this[b]); b++)
          1 === a.nodeType && (n.cleanData($(a, !1)), (a.textContent = ''));
        return this;
      },
      clone: function (a, b) {
        return (
      ...
      replaceWith: function () {
        ...
        return ta(
          ...
          function (b) {
            ...
            n.inArray(this, a) < 0 &&
              (n.cleanData($(this)), c && c.replaceChild(b, this));
          },
          a
        );
      },
  ...
  function ya(a) {
    ...
    return (
      c ||
        ...
        ('none' !== c && c) ||
          ((va = (
            va || n("<iframe frameborder='0' width='0' height='0'/>")
  ...
  var Ga = /^(none|table(?!-c[ea]).+)/,
    Ha = { position: 'absolute', visibility: 'hidden', display: 'block' },
    Ia = { letterSpacing: '0', fontWeight: '400' },
    Ja = ['Webkit', 'O', 'Moz', 'ms'],
    Ka = d.createElement('div').style;
  function La(a) {
    if (a in Ka) return a;
    var b = a[0].toUpperCase() + a.slice(1),
      c = Ja.length;
    while (c--) if ((a = Ja[c] + b) in Ka) return a;
  }
  function Ma(a, b, c) {
    var d = S.exec(b);
  ...
  function Oa(b, c, e) {
    ...
    return g + Na(b, c, e || (i ? 'border' : 'content'), f, h) + 'px';
  }
  function Pa(a, b) {
    for (var c, d, e, f = [], g = 0, h = a.length; g < h; g++)
      (d = a[g]),
        d.style &&
          ((f[g] = M.get(d, 'olddisplay')),
          (c = d.style.display),
          b
            ? (f[g] || 'none' !== c || (d.style.display = ''),
              '' === d.style.display &&
                U(d) &&
                (f[g] = M.access(d, 'olddisplay', ya(d.nodeName))))
            : ((e = U(d)),
              ('none' === c && e) ||
                M.set(d, 'olddisplay', e ? c : n.css(d, 'display'))));
    for (g = 0; g < h; g++)
      (d = a[g]),
        d.style &&
  ...
  n.extend({
    ...
    style: function (a, b, c, d) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        var e,
          ...
          i = a.style;
        if (
          ((b = n.cssProps[h] || (n.cssProps[h] = La(h) || h)),
    ...
    n.each(['height', 'width'], function (a, b) {
      n.cssHooks[b] = {
        get: function (a, c, d) {
          if (c)
            return Ga.test(n.css(a, 'display')) && 0 === a.offsetWidth
              ? Ca(a, Ha, function () {
                  return Oa(a, b, d);
                })
              : Oa(a, b, d);
        ...
        set: function (a, c, d) {
          var e,
            ...
            g =
              d &&
              Na(a, b, d, 'border-box' === n.css(a, 'boxSizing', !1, f), f);
          return (
            g &&
              (e = S.exec(c)) &&
              'px' !== (e[3] || 'px') &&
    ...
    (n.cssHooks.marginLeft = Fa(l.reliableMarginLeft, function (a, b) {
      if (b)
        return (
          (parseFloat(Ea(a, 'marginLeft')) ||
    ...
    (n.cssHooks.marginRight = Fa(l.reliableMarginRight, function (a, b) {
      if (b) return Ca(a, { display: 'inline-block' }, Ea, [a, 'marginRight']);
    })),
    n.each({ margin: '', padding: '', border: 'Width' }, function (a, b) {
      (n.cssHooks[a + b] = {
        ...
        za.test(a) || (n.cssHooks[a + b].set = Ma);
    }),
    n.fn.extend({
      css: function (a, b) {
        return J(
  ...
  function Qa(a, b, c, d, e) {
    return new Qa.prototype.init(a, b, c, d, e);
  }
  (n.Tween = Qa),
    (Qa.prototype = {
      constructor: Qa,
      ...
      cur: function () {
        var a = Qa.propHooks[this.prop];
        return a && a.get ? a.get(this) : Qa.propHooks._default.get(this);
      },
      run: function (a) {
        var b,
          c = Qa.propHooks[this.prop];
        return (
          ...
          c && c.set ? c.set(this) : Qa.propHooks._default.set(this),
          this
        );
      },
    }),
    (Qa.prototype.init.prototype = Qa.prototype),
    (Qa.propHooks = {
      _default: {
        get: function (a) {
          var b;
    ...
    (Qa.propHooks.scrollTop = Qa.propHooks.scrollLeft =
      {
        set: function (a) {
  ...
  function Xa(a, b, c) {
    for (
      var d,
        e = ($a.tweeners[b] || []).concat($a.tweeners['*']),
        f = 0,
        g = e.length;
      f < g;
      f++
  ...
  function Ya(a, b, c) {
    ...
    c.queue ||
      ...
      1 === a.nodeType &&
        ...
        (j = n.css(a, 'display')),
        'inline' ===
          (k = 'none' === j ? M.get(a, 'olddisplay') || ya(a.nodeName) : j) &&
          'none' === n.css(a, 'float') &&
    ...
    if (n.isEmptyObject(m))
      'inline' === ('none' === j ? ya(a.nodeName) : j) && (o.display = j);
    else {
      q ? 'hidden' in q && (p = q.hidden) : (q = M.access(a, 'fxshow', {})),
        f && (q.hidden = !p),
        p
          ? n(a).show()
          : l.done(function () {
  ...
  function $a(a, b, c) {
    var d,
      ...
      k = j.props;
    for (Za(k, j.opts.specialEasing); f < g; f++)
      if ((d = $a.prefilters[f].call(j, a, k, j.opts)))
        return (
          n.isFunction(d.stop) &&
  ...
  (n.Animation = n.extend($a, {
    tweeners: {
      '*': [
        function (a, b) {
          var c = this.createTween(a, b);
          return V(c.elem, a, S.exec(b), c), c;
        },
      ],
    },
    tweener: function (a, b) {
      ...
      for (var c, d = 0, e = a.length; d < e; d++)
        (c = a[d]),
          ($a.tweeners[c] = $a.tweeners[c] || []),
          $a.tweeners[c].unshift(b);
    },
    prefilters: [Ya],
    ...
    (n.fx.tick = function () {
      var a,
        b = 0,
        c = n.timers;
      for (Ra = n.now(); b < c.length; b++)
        (a = c[b])() || c[b] !== a || c.splice(b--, 1);
      c.length || n.fx.stop(), (Ra = void 0);
    }),
    ...
    (n.fx.interval = 13),
    (n.fx.start = function () {
      Sa || (Sa = a.setInterval(n.fx.tick, n.fx.interval));
    }),
    (n.fx.stop = function () {
      a.clearInterval(Sa), (Sa = null);
    }),
        ...
        if (3 !== f && 8 !== f && 2 !== f)
          return void 0 === a.getAttribute
            ...
            : ((1 === f && n.isXMLDoc(a)) ||
                ((b = b.toLowerCase()),
                (e =
                  n.attrHooks[b] || (n.expr.match.bool.test(b) ? _a : void 0))),
              void 0 !== c
                ? null === c
  ...
  n.fn.extend({
    addClass: function (a) {
      ...
      if (n.isFunction(a))
        return this.each(function (b) {
          n(this).addClass(a.call(this, b, eb(this)));
        });
    ...
    removeClass: function (a) {
      ...
      if (n.isFunction(a))
        return this.each(function (b) {
          n(this).removeClass(a.call(this, b, eb(this)));
        });
    ...
    toggleClass: function (a, b) {
      ...
      return 'boolean' == typeof b && 'string' === c
        ...
        ? this.each(function (c) {
            n(this).toggleClass(a.call(this, c, eb(this), b), b);
          })
        : this.each(function () {
            var b, d, e, f;
            if ('string' === c) {
            ...
            } else (void 0 !== a && 'boolean' !== c) || ((b = eb(this)), b && M.set(this, '__className__', b), this.setAttribute && this.setAttribute('class', b || !1 === a ? '' : M.get(this, '__className__') || ''));
          });
    },
    hasClass: function (a) {
      var b,
      ...
      valHooks: {
        option: {
          get: function (a) {
            ...
            return null != b ? b : n.trim(n.text(a)).replace(gb, ' ');
          },
        },
        select: {
          get: function (a) {
    ...
    while (f)
      if (
        ...
        if ('*' === f) f = i;
          ...
          if (a.crossDomain && 'script' === f) continue;
          if (!(g = j[i + ' ' + f] || j['* ' + f]))
            for (e in j)
              if (
                ((h = e.split(' ')),
  ...
  (n.offset = {
    ...
    n.each(['top', 'left'], function (a, b) {
      n.cssHooks[b] = Fa(l.pixelPosition, function (a, c) {
        if (c)
          return (c = Ea(a, b)), Aa.test(c) ? n(a).position()[b] + 'px' : c;
      });
    }),
