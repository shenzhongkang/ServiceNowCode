...
opersNS.compile = function (ops_input, opsdef) {
  for (var fieldType in ops_input) {
    ...
    if (proto.charAt(0) == '=') continue;
    var opers = proto.split(',');
    var opArray = [];
    for (var i = 0; i < opers.length; i++) {
      var oper = opers[i];
      if (oper) opArray.push(opsdef[oper]);
    }
...
var sysopers = {
  ...
  calendar:
    'on,nton,bf,atbf,af,ataf,btw,dtpt,rltv,snc,em,ntem,any,fvc,saas,nsas,date_more,date_less',
  ...
  integer:
    'eq,nteq,em,ntem,lt,gt,lteq,gteq,btw,any,fvc,fvf,fvt,saas,nsas,gtfd,ltfd,gteqfd,lteqfd',
  integer_choice:
    'eq,nteq,inna,ntin,em,ntem,lt,gt,lteq,gteq,btw,any,fvc,fvf,fvt,saas,nsas',
  journal: 'fvc',
  ...
  reference:
    'eq,nteq,em,ntem,stwt,enwt,lk,ntlk,any,saas,nsas,es,eqd,fvc,fvf,fvt',
  ...
  string:
    'stwt,enwt,lk,ntlk,eq,nteq,em,ntem,mpat,mreg,any,inna,es,fvc,fvf,fvt,lteq,gteq,btw,saas,nsas',
...
var MESSAGES_CONDITION_RELATED_FILES = [
  'lowercase_fields',
  'Keywords',
  'Show Related Fields',
