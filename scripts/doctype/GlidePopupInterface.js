...
(function(exports) {
  ...
  function popListDiv(evt, target, sys_id, view, width, showOpenButton, trapFocus) {
      var onReady = function() {
          nowapi.g_popup_manager.popListDiv(evt, target, sys_id, view, width, showOpenButton, trapFocus);
      };
  ...
  function popReferenceDiv(evt, inputId, view, form, refKey) {
      var onReady = function() {
          nowapi.g_popup_manager.popReferenceDiv(evt, inputId, view, form, refKey, true);
      };
  ...
  function popForm(evt, target, sys_id, view, width) {
      ScriptLoader.getScripts("scripts/classes/nowapi/ui/GlidePopup.js", function() {
          nowapi.g_popup_manager.popForm(evt, target, sys_id, view, width);
      });
  }
  ...
  function popRecordDiv(evt, table, sys_id, view, width) {
      var onReady = function() {
          nowapi.g_popup_manager.popRecordDiv(evt, table, sys_id, view, width);
      };
  ...
  function popHistoryDiv(evt, table, sys_id, checkpoint, internalCP) {
      ScriptLoader.getScripts("scripts/classes/nowapi/ui/GlidePopup.js", function() {
          nowapi.g_popup_manager.popHistoryDiv(evt, table, sys_id, checkpoint, internalCP);
      });
  }
