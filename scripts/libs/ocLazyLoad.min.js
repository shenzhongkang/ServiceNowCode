                ...
                if (l.insertBefore) {
                  var v = e.element(
                    e.isDefined(window.jQuery)
                      ? l.insertBefore
                      : document.querySelector(l.insertBefore)
                  );
                  v && v.length > 0 && (m = v[0]);
                }
          ...
          function (n, r) {
            return (
              (n.filesLoader = function (o) {
                ...
                var d = function (r) {
                  var o,
                    d = null;
                  if (
                    (e.isObject(r) && ((d = r.type), (r = r.path)),
                    (c = l.get(r)),
                    e.isUndefined(c) || t.cache === !1)
                  ) {
                    if (
                      (null !== (o = /^(css|less|html|htm|js)?(?=!)/.exec(r)) &&
                        ((d = o[1]), (r = r.substr(o[1].length + 1, r.length))),
                      !d)
                    )
                      if (
                        null !==
                    ...
                    ('css' !== d && 'less' !== d) || -1 !== i.indexOf(r)
                      ? ('html' !== d && 'htm' !== d) || -1 !== a.indexOf(r)
                        ? 'js' === d || -1 === s.indexOf(r)
                          ? s.push(r)
              ...
              (n.load = function (o) {
                ...
                if (
                  (e.isString(l)
                    ? ((s = a.getModuleConfig(l)), s || (s = { files: [l] }))
                    : e.isObject(l) &&
                      (s =
                        e.isDefined(l.path) && e.isDefined(l.type)
                          ? { files: [l] }
                          : a.setModuleConfig(l)),
                  null === s)
                ) {
                    ...
                    u.push(i.promise),
                      t
                        ...
                        .error(function (e) {
                          i.reject(
                            new Error(
                              'Unable to load template file "' + n + '": ' + e
                            )
                          );
                        });
                  }),
